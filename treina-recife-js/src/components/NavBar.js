            ...
            <div className="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <Link className="nav-link text-white active bg-gradient-warning" to={`/`}>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link text-dark" to={`/turmas`}>
                    ...
                    <li className="nav-item">
                        <Link className="nav-link text-dark" to={`/cursos`}>
                            <div className="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link text-dark" to={`/professores`}>
                            <div className="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link text-dark" to={`/perfil`}>
                            <div className="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link text-dark" to={`/sign-in`}>
                            <div className="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link text-dark" to={`/sign-up`}>
                            <div className="text-dark text-center me-2 d-flex align-items-center justify-content-center">
